# OCI Landing Zones Autonomous Database Example - Autonomous Database Serverless Standalone
...
2. A KMS key in *\<service-label\>-vault*, in the same compartment where the Autonomous Database (ADB) will be provisioned.
